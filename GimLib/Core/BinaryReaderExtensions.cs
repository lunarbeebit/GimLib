...
public static class BinaryReaderExtensions
{
    ...
    public static void At(this BinaryReader reader, long position, Action<BinaryReader> func)
    {
        ...
        if (origPosition != position) reader.BaseStream.Position = position;
    ...
    /// <summary>
    ///     Reads a 2-byte signed integer from the current stream in big-endian format and advances the current position of the
    ///     stream by two bytes.
    /// </summary>
    /// <param name="reader"></param>
    ...
    /// <summary>
    ///     Reads a 4-byte signed integer from the current stream in big-endian format and advances the current position of the
    ...
    /// <summary>
    ///     Reads an 8-byte signed integer from the current stream in big-endian format and advances the current position of
    ...
    /// <summary>
    ///     Reads a 2-byte unsigned integer from the current stream in big-endian format and advances the position of the
    ///     stream by two bytes.
    /// </summary>
    /// <param name="reader"></param>
    ...
    /// <summary>
    ///     Reads a 4-byte unsigned integer from the current stream in big-endian format and advances the position of the
    ///     stream by four bytes.
    /// </summary>
    /// <param name="reader"></param>
    ...
    /// <summary>
    ///     Reads an 8-byte unsigned integer from the current stream in big-endian format and advances the position of the
    ...
    /// <summary>
    ///     Reads a 2-byte signed integer from the current stream in the specified endianness and advances the current position
    ...
    /// <summary>
    ///     Reads a 4-byte signed integer from the current stream in the specified endianness and advances the current position
    ...
    /// <summary>
    ///     Reads an 8-byte signed integer from the current stream in the specified endianness and advances the current
    ...
    /// <summary>
    ///     Reads a 2-byte unsigned integer from the current stream in the specified endianness and advances the position of
    ...
    /// <summary>
    ///     Reads a 4-byte unsigned integer from the current stream in the specified endianness and advances the position of
    ...
    /// <summary>
    ///     Reads an 8-byte unsigned integer from the current stream the specified endianness and advances the position of the
    ///     stream by eight bytes.
    /// </summary>
    /// <param name="reader"></param>
    /// <param name="endianness">The endianess of the value to read.</param>
    ...
    {
        return reader.ReadString(count, Encoding.UTF8);
    }
    ...
    public static string ReadString(this BinaryReader reader, int count, Encoding encoding)
    {
        ...
        if (indexOfNull != -1) s = s.Remove(indexOfNull);
