...
public static class BinaryWriterExtensions
{
    ...
    public static void At(this BinaryWriter writer, long position, Action<BinaryWriter> func)
    {
        ...
        if (origPosition != position) writer.BaseStream.Position = position;
    ...
    /// <summary>
    ///     Writes a two-byte signed integer in big-endian format to the current stream and advances the stream position by two
    ///     bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(short)" />
    ...
    /// <summary>
    ///     Writes a four-byte signed integer in big-endian format to the current stream and advances the stream position by
    ///     four bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(int)" />
    ...
    /// <summary>
    ///     Writes an eight-byte signed integer in big-endian format to the current stream and advances the stream position by
    ///     eight bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(long)" />
    ...
    /// <summary>
    ///     Writes a two-byte unsigned integer in big-endian format to the current stream and advances the stream position by
    ///     two bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(ushort)" />
    ...
    /// <summary>
    ///     Writes a four-byte unsigned integer in big-endian format to the current stream and advances the stream position by
    ///     four bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(uint)" />
    ...
    /// <summary>
    ///     Writes an eight-byte unsigned integer in big-endian format to the current stream and advances the stream position
    ///     by eight bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(ulong)" />
    ...
    /// <summary>
    ///     Writes a two-byte signed integer in the specified endianness to the current stream and advances the stream position
    ///     by two bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(short)" />
    ...
    /// <summary>
    ///     Writes a four-byte signed integer in the specified endianness to the current stream and advances the stream
    ...
    /// <summary>
    ///     Writes an eight-byte signed integer the specified endianness to the current stream and advances the stream position
    ///     by eight bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(long)" />
    ...
    /// <summary>
    ///     Writes a two-byte unsigned integer the specified endianness to the current stream and advances the stream position
    ///     by two bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(ushort)" />
    ...
    /// <summary>
    ///     Writes a four-byte unsigned integer the specified endianness to the current stream and advances the stream position
    ///     by four bytes.
    /// </summary>
    /// <inheritdoc cref="BinaryWriter.Write(uint)" />
    ...
    /// <summary>
    ///     Writes an eight-byte unsigned integer the specified endianness to the current stream and advances the stream
    ...
    /// <summary>
    ///     Writes a string to this stream, and advances the current position of the stream by the number of bytes specified in
    ///     <paramref name="count" />.
    /// </summary>
    /// <param name="writer"></param>
    ...
    public static void WriteString(this BinaryWriter writer, string value, int count)
    {
        writer.WriteString(value, count, Encoding.UTF8);
    }

    /// <summary>
    ///     Writes a string to this stream using the specified encoding, and advances the current position of the stream by the
    ///     number of bytes specified in <paramref name="count" />.
    /// </summary>
    /// <param name="writer"></param>
    /// <param name="value">The value to write.</param>
    /// <param name="count">The number of bytes to write.</param>
    ...
    /// <summary>
    ///     Writes a null-terminated string to this stream, and advances the current position of the stream by the length of
    ///     <paramref name="value" /> in bytes plus one.
    /// </summary>
    /// <param name="writer"></param>
    /// <param name="value">The value to write.</param>
    ...
    {
        return writer.WriteNullTerminatedString(value, Encoding.UTF8);
    }

    /// <summary>
    ///     Writes a null-terminated string to this stream using the specified encoding, and advances the current position of
    ///     the stream by the length of <paramref name="value" /> in bytes plus one.
    /// </summary>
    /// <param name="writer"></param>
    /// <param name="value">The value to write.</param>
    /// <param name="encoding">The character encoding to use.</param>
    ...
    {
        var position = writer.BaseStream.Position - offset;
