...
public class GtxTextureEncoder
{
    ...
    public GtxTextureEncoder(string path, GtxPixelFormat pixelFormat)
    ...
    /// <param name="pixelFormat">Pixel format to encode the texture to.</param>
    /// <param name="dataFormat">Data format to encode the texture to.</param>
    public GtxTextureEncoder(string path, GtxPaletteFormat? paletteFormat, GtxPixelFormat pixelFormat)
    {
    ...
    /// <param name="pixelFormat">Pixel format to encode the texture to.</param>
    /// <param name="dataFormat">Data format to encode the texture to.</param>
    public GtxTextureEncoder(Stream source, GtxPixelFormat pixelFormat)
    ...
    /// <param name="pixelFormat">Pixel format to encode the texture to.</param>
    /// <param name="dataFormat">Data format to encode the texture to.</param>
    public GtxTextureEncoder(Stream source, GtxPaletteFormat? paletteFormat, GtxPixelFormat pixelFormat)
    {
    ...
    /// </summary>
    public GtxPaletteFormat? PaletteFormat { get; private set; }

    /// <summary>
    ///     Gets the pixel format.
    /// </summary>
    public GtxPixelFormat PixelFormat { get; private set; }
    ...
    private void Initialize(Stream source, GtxPaletteFormat? paletteFormat, GtxPixelFormat pixelFormat)
    {
