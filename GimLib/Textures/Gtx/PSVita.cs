...
namespace GimLib.Textures.Gtx
{
    ...
    public class SceGxtHeader
    {
        ...
        public SceGxtHeader(BinaryReader reader)
        {
            MagicNumber = reader.ReadString(4, Encoding.ASCII);
            Version = reader.ReadUInt32(Endianness.Little);
            NumTextures = reader.ReadUInt32(Endianness.Little);
            TextureDataOffset = reader.ReadUInt32(Endianness.Little);
            TextureDataSize = reader.ReadUInt32(Endianness.Little);
            NumP4Palettes = reader.ReadUInt32(Endianness.Little);
            NumP8Palettes = reader.ReadUInt32();
            Padding = reader.ReadUInt32(Endianness.Little);
        }
    }
    ...
    public abstract class SceGxtTextureInfo
    {
        ...
        public SceGxtTextureInfo(BinaryReader reader)
        {
            DataOffset = reader.ReadUInt32(Endianness.Little);
            DataSize = reader.ReadUInt32(Endianness.Little);
            PaletteIndex = reader.ReadInt32(Endianness.Little);
            Flags = reader.ReadUInt32(Endianness.Little);
            ControlWords = new uint[4];
            for (int i = 0; i < ControlWords.Length; i++) ControlWords[i] = reader.ReadUInt32(Endianness.Little);
        }
    ...
    {
        public SceGxtTextureInfoV301(BinaryReader reader) : base(reader) { }
    ...
    {
        public SceGxtTextureInfoV201(BinaryReader reader) : base(reader) { }
    ...
    {
        public SceGxtTextureInfoV101(BinaryReader reader) : base(reader) { }
    ...
    public class BUVChunk
    {
        ...
        public BUVChunk(BinaryReader reader)
        {
            MagicNumber = reader.ReadString(4, Encoding.ASCII);
            NumEntries = reader.ReadUInt32(Endianness.Little);
    ...
    public class BUVEntry
    {
        ...
        public BUVEntry(BinaryReader reader)
        {
            X = reader.ReadUInt16(Endianness.Little);
            Y = reader.ReadUInt16(Endianness.Little);
            Width = reader.ReadUInt16(Endianness.Little);
            Height = reader.ReadUInt16(Endianness.Little);
            PaletteIndex = reader.ReadInt16(Endianness.Little);
            Unknown0x0A = reader.ReadUInt16(Endianness.Little);
        }
    }
